...
where TEdge : IEdge
{
    ...
    /// <returns>Object that contains List of layers where each layer is a list of nodes at a certain layer of topological sort.<br/> 
    /// Use <see langword="TopologicalSorter.ApplyTopologicalSort"/> to change X coordinates to a certain value defined by sorting.</returns>
